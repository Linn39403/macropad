...
{
    uint8_t u8ActiveLayer = SCREEN_u8GetActiveLayer();
    bool boEncoderLeftPushBtnStateNow = gpio_read_pin(ENCODER_LEFT_PUSH_BUTTON_PIN);
    bool boEncoderMainPushBtnStateNow = gpio_read_pin(ENCODER_MAIN_PUSH_BUTTON_PIN);
